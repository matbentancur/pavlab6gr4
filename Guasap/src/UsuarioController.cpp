...
void UsuarioController::cargarDatosPrueba(){
    ...
    FechaHora agregado = FechaHora(22,5,2018,18,12);
    UsuarioConversacion* u5g1 = new UsuarioConversacion(agregado,activa,g1); //PRUEBAS
    ...
    //MENSAJES
    FechaHora fhm1 = FechaHora(22,5,2017,18,4);
    ...
    FechaHora fhm2 = FechaHora(22,5,2018,18,5);
    ...
    FechaHora fhm3 = FechaHora(22,5,2018,18,12);
    ...
    FechaHora fhm4 = FechaHora(22,5,2018,18,13);
    ...
    FechaHora fhm5 = FechaHora(23,5,2018,12,23);
    ...
    FechaHora fhm6 = FechaHora(23,5,2018,12,25);
    ...
    FechaHora fhm7 = FechaHora(23,5,2018,12,26);
    ...
    FechaHora fhm8 = FechaHora(23,5,2018,18,30);
